  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 flex">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-secondary-500/20 rounded-full mix-blend-multiply filter blur-xl animate-pulse" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-info/10 rounded-full mix-blend-multiply filter blur-xl animate-pulse" style={{ animationDelay: '4s' }}></div>
      </div>
        ...
        <div className="max-w-md">
          <div className="mb-8">
            ...
            <h2 className="text-4xl font-bold text-white mb-4">
              ...
              <span className="bg-gradient-to-r from-primary-400 to-secondary-400 bg-clip-text text-transparent"> Mercado Digital</span>
            </h2>
            <p className="text-neutral-300 text-lg">
              Plataforma inteligente para acompanhar criptomoedas em tempo real e tomar decisões informadas.
            </p>
          </div>
      ...
      {/* Login Form */}
      <div className="flex-1 flex items-center justify-center mt-20 p-8 relative z-10">
        <div className="w-full max-w-md mt-10">
            ...
            <div className="p-8">
              ...
              <div className="lg:hidden text-center mb-8">
                <div className="flex items-center justify-center space-x-3 mb-4">
                  ...
                  <h1 className="text-2xl font-bold text-neutral-900">PriceGuard</h1>
                </div>
              </div>
              ...
              <div className="space-y-6">
                {skipAuth && (
                  ...
                  >
                    ...
                    <Sparkle size={16} className="ml-2 group-hover:animate-pulse" />
                  </button>
                )}
              ...
              <div className="mt-8 text-center space-y-2">
                ...
                <p className="text-sm text-neutral-600">
                  Esqueceu a senha?{" "}
                  <a href="/reset-password" className="font-medium text-primary-600 hover:text-primary-500 transition-colors">
                    Redefinir
                  </a>
                </p>
              </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-neutral-400 text-sm mb-4">Confiado por mais de 50.000 usuários</p>
